...
- Check upstream issues/releases with `search_github`, `gh`, and community search (`search_hackernews`, `search_reddit`) when the flake may come from a dependency or hosted service.
